/* 
Exercise
1. Create a map with the following keys: name , profession , country and city . For the values, add your
information.
...
Write a function that takes a paragraph of text as a parameter. Count the frequency of each 
character. Return this data as a map where the key is the character and the value is the
frequency count.
*/
